...
abstract class BaseBookFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'reading_status' => new sfWidgetFormChoice(array('choices' => array('' => '', 'Read' => 'Read', 'Unread' => 'Unread'))),
    ...
    $this->setValidators(array(
      ...
      'reading_status' => new sfValidatorChoice(array('required' => false, 'choices' => array('Read' => 'Read', 'Unread' => 'Unread'))),
