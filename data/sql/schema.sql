...
CREATE TABLE books (id INT AUTO_INCREMENT, title VARCHAR(50) NOT NULL, author_id INT NOT NULL, category_id INT NOT NULL, is_read TINYINT(1) DEFAULT '0' NOT NULL, rating INT DEFAULT 1 NOT NULL, description TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX author_id_idx (author_id), INDEX category_id_idx (category_id), PRIMARY KEY(id)) ENGINE = INNODB;
